...
# count = 2909
# with open('./data/ENTITY/1/ollama embeddings.txt', 'r') as embeddingsfile:
#     for i in embeddingsfile.readlines():
#         vec1 = eval(i.strip().split('\t')[1])
#         if vec1 == None:
#             count += 1
#             with open(f'./data/ENTITY/1/similarity/{count}similarity.txt', 'w') as file:
#                 file.write('[]')
#             continue
#         list_similarity = []
#         with open('./data/ENTITY/1/ollama embeddings.txt', 'r') as file:
#             current = 2909
...
with open('./data/ENTITY/1/similarity.txt', 'w') as file:
